 ...
 * @author baontq
 */
public class Bai_4_UserForm extends javax.swing.JFrame {
    private List<User> list = new ArrayList<>();
    private DefaultTableModel tblmodel;
    /**
     * Creates new form UserForm
     */
    public Bai_4_UserForm() {
        initComponents();
    ...
    public void intiData() {
        list.add(new User("dangthpc", "dang@fpt", "Admin"));
        list.add(new User("Antkpc", "an123", "User"));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bai_4_UserForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Bai_4_UserForm().setVisible(true);
            }
        });
    }
