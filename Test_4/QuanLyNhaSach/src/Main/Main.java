...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jplAddTopping = new javax.swing.JPanel();
        jcbTranChau = new javax.swing.JCheckBox();
        jcbRauCau = new javax.swing.JCheckBox();
        jcbBanhFlan = new javax.swing.JCheckBox();
        ...
        jplAddTopping.setBackground(new java.awt.Color(255, 204, 204));
        jplAddTopping.setBorder(javax.swing.BorderFactory.createTitledBorder("Thêm Topping"));
        jplAddTopping.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jcbTranChau.setText("Trân Châu 10k");
        jplAddTopping.add(jcbTranChau, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, -1, -1));

        jcbRauCau.setText("Rau câu 5k");
        jcbRauCau.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jcbRauCauActionPerformed(evt);
            }
        });
        jplAddTopping.add(jcbRauCau, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, -1, -1));

        jcbBanhFlan.setText("Bánh Flan 10k");
        jplAddTopping.add(jcbBanhFlan, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, -1, -1));

        getContentPane().add(jplAddTopping, new org.netbeans.lib.awtextra.AbsoluteConstraints(546, 96, 140, 190));

        jLabel2.setText("Thành Tiền");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(116, 256, 90, 20));

        jLabel3.setText("Mã Thức Uống");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(116, 96, 100, 20));

        jLabel4.setText("Tên Thức Uống");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(116, 136, 100, 20));

        jLabel5.setText("Số Lượng");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(116, 176, 100, 20));

        jLabel6.setText("Đơn Giá");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(116, 216, 70, 20));
        getContentPane().add(txtThanhTien, new org.netbeans.lib.awtextra.AbsoluteConstraints(226, 256, 160, 30));
        getContentPane().add(txtMaThucUong, new org.netbeans.lib.awtextra.AbsoluteConstraints(226, 96, 260, 30));
        getContentPane().add(txtTenThucUong, new org.netbeans.lib.awtextra.AbsoluteConstraints(226, 136, 260, 30));
        getContentPane().add(txtSoLuong, new org.netbeans.lib.awtextra.AbsoluteConstraints(226, 176, 260, 30));
        getContentPane().add(txtDonGia, new org.netbeans.lib.awtextra.AbsoluteConstraints(226, 216, 260, 30));
        ...
        getContentPane().add(btnTinhTien, new org.netbeans.lib.awtextra.AbsoluteConstraints(406, 256, 80, 30));
        ...
        getContentPane().add(btnLuuFile, new org.netbeans.lib.awtextra.AbsoluteConstraints(506, 376, 110, 30));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(146, 326, 80, 30));
        ...
        getContentPane().add(btnThem, new org.netbeans.lib.awtextra.AbsoluteConstraints(246, 326, 90, 30));
        ...
        getContentPane().add(btnCapNhat, new org.netbeans.lib.awtextra.AbsoluteConstraints(356, 326, 100, 30));
        ...
        getContentPane().add(btnXoa, new org.netbeans.lib.awtextra.AbsoluteConstraints(466, 326, 80, 30));
        ...
        getContentPane().add(btnFind, new org.netbeans.lib.awtextra.AbsoluteConstraints(106, 376, 100, 30));
        ...
        getContentPane().add(btnSort, new org.netbeans.lib.awtextra.AbsoluteConstraints(226, 376, 130, 30));
        ...
        getContentPane().add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(376, 376, 110, 30));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(46, 446, 700, 110));
    ...
    private void jcbRauCauActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcbRauCauActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jcbRauCauActionPerformed
    ...
    private javax.swing.JCheckBox jcbBanhFlan;
    private javax.swing.JCheckBox jcbRauCau;
    private javax.swing.JCheckBox jcbTranChau;
    private javax.swing.JPanel jplAddTopping;
